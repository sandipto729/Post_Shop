...
export function AnimatedModal() {
  ...
  return (
    (<div className="py-40 flex w-24 items-center justify-center">
      <Modal className='w-full'>
        <ModalTrigger
          className="w-full bg-primary dark:bg-white dark:text-black text-white flex justify-center group/modal-btn">
          <span
